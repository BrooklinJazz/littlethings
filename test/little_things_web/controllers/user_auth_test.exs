defmodule LittleThingsWeb.UserAuthTest do
  use LittleThingsWeb.ConnCase, async: true

  alias LittleThings.Accounts
  alias LittleThingsWeb.UserAuth
  import LittleThings.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, LittleThingsWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      LittleThingsWeb.Endpoint.subscribe(live_socket_id)
