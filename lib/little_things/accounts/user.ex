defmodule LittleThings.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, LittleThings.Repo)
  ...
  """
  def valid_password?(%LittleThings.Accounts.User{hashed_password: hashed_password}, password)
